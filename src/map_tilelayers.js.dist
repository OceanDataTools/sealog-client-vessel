...
export const TILE_LAYERS = (USE_MAPTILE_PROXY) ? [
  ...
  {
    name: "Carto Voyager",
    attribution: '&copy <a href="http://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap</a> contributors, &copy <a href="https://carto.com/about-carto/">voyager_all</a>',
  ...
  },
  {
    ...
    attribution: '&copy 2032 <a href="http://gmrt.marine-geo.org" target="_blank" rel="noopener">GMRT</a>',
    layers: "topo",
    transparent: false
  }
]
