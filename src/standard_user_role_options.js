...
export const standardUserRoleOptions = [
  { value: 'cruise_manager', label: `${_Cruise_} Manager`, description: `Ability to edit ${_cruises_}.` },
  { value: 'template_manager', label: 'Template Manager', description: 'Ability to edit event templates.' },
  { value: 'event_manager', label: 'Event Manager', description: `Ability to review events independent of ${_cruises_}.` },
