...
class CruiseModeDropdownToggle extends Component {
  constructor(props) {
    super(props);
...
class CruiseModeDropdownMenu extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Dropdown as={'span'} id="dropdown-custom-menu">
        <Dropdown.Toggle as={CruiseModeDropdownToggle}>{this.state.toggleText}</Dropdown.Toggle>
        <Dropdown.Menu as={CruiseModeDropdownMenu} style={this.dropdownMenuStyle}>
